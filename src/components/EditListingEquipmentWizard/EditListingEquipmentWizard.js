...
import EditListingWizardTab, {
  ...
  LOCATION,
  PRICING,
} from './EditListingEquipmentWizardTab';
...
export const TABS = [GENERAL, AVAILABILITY, LOCATION, PRICING, ...availabilityMaybe];
...
const tabLabel = (intl, tab) => {
  let key = null;
  if (tab === GENERAL) {
    key = 'EditListingEquipmentWizard.tabLabelGeneral';
  } else if (tab === AVAILABILITY) {
    key = 'EditListingEquipmentWizard.tabLabelAvailability';
  } else if (tab === LOCATION) {
    key = 'EditListingEquipmentWizard.tabLabelLocation';
  } else if (tab === PRICING) {
    key = 'EditListingEquipmentWizard.tabLabelPricing';
  }
