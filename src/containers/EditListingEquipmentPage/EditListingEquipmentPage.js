...
import { EditListingEquipmentWizard, NamedRedirect, Page } from '../../components';
...
import {
  ...
  clearUpdatedTab,
  savePayoutDetails,
} from './EditListingEquipmentPage.duck';

import css from './EditListingEquipmentPage.module.css';
...
export const EditListingPageComponent = props => {
  ...
  if (shouldRedirect) {
    ...
    const title = isNewListingFlow
      ? intl.formatMessage({ id: 'EditListingEquipmentPage.titleCreateListing' })
      : intl.formatMessage({ id: 'EditListingEquipmentPage.titleEditListing' });
    ...
    return (
      <Page title={title} scrollingDisabled={scrollingDisabled}>
        ...
        />
        <EditListingEquipmentWizard
          id="EditListingEquipmentWizard"
